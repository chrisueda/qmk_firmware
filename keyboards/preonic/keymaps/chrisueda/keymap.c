...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, LGUI(KC_Q), LGUI(KC_W), _______, _______, _______, _______, _______, KC_UP, KC_UNDS, KC_PLUS, _______,  \
  KC_DEL,  LGUI(KC_A), LGUI(KC_S), LGUI(KC_D), LGUI(KC_F), _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_PIPE, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  KC_DEL,  _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_BSLS, \
  KC_LSPO, _______, _______, _______, _______, _______, _______, KC_EQL, LSFT(KC_DOT), _______, _______, _______, \
